...
All statistical computations were performed in Python 3.11 using SciPy (v1.11) and are fully reproducible via the provided \texttt{publication/generate\_figures.py} script \cite{ref27}.
